...
def init_system():
    try:
        collock_data = {}
        hostname_k8s = subprocess.getstatusoutput('hostnamectl set-hostname k8s-node1 && echo "127.0.0.1   $(hostname)" >> /etc/hosts')
